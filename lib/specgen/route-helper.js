...
var routeHelper = module.exports = {
  ...
  acceptToParameter: function acceptToParameter(route, classDef, typeRegistry, opts) {
    ...
    return function(accepts) {
      ...
      if (paramObject.description && paramObject.description.indexOf(' id') === paramObject.description.length - ' id'.length && paramObject.name === 'id' && paramObject.in === 'path' && paramObject.type === 'object' && paramObject.format === 'JSON') {
